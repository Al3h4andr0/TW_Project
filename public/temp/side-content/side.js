...
export default class Side {
    ...
    renderOverview(locationOverview, id) {
        ...
        return `
            <div class="locationOverview">
             ...
             <p class="subtitleSmaller">For: <span class="locationFor${v}">${locationOverview.for}</span></p>
             </div>
             ${dates}
    ...
    renderReviews(locationReviews, id) {
        ...
        for (let value of Object.values(locationReviews)) {
            res += `<div class="locationReview descText" id="locationReview${id}${i}">
           ${value.title}
           </br>
           ${value.description}
           </br>
        ...
        for (let location of locations) {
            ...
            <div class="location" id="location${location.id}">
                ...
                <div class="locationDesc">
                    ...
                    <rect width="37" height="37" fill="url(#pattern${location.id})"/>
                    <defs>
                    <pattern id="pattern${location.id}" patternContentUnits="objectBoundingBox" width="1" height="1">
                             ...
                             <form class="rent_form">
                               <button type="button" class="rent_form_cancel" id="rent_form_cancel${location.id}"> Cancel </button>
                                 <div class="dates row">
                                   ...
                                   <input type="date" value="2022-06-20" min="2022-05-10">
                                   <input type="date" value="2022-06-20" max="2022-07-10">
                              </div>
