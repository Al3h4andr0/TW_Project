...
function openFilters() {
 document.getElementById("filter-div").classList.toggle("active");
}
...
document.addEventListener("click", (e) => {
  ...
  if(e.target.closest("#filter-div") == null && filterDiv.classList.contains("active") && !e.target.closest("#ui-filter"))
...
// {
//   var filterTopZone =document.getElementById("filter-div");
